      ...
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="md:w-3/4">
          ...
          <p className="text-gray-700 mb-4">
            ...
            sources. Our AI doesn&rsquo;t just aggregate - it compares different perspectives, identifies key facts, and
            presents a comprehensive view of each story.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
            <div className="flex items-start">
              <Newspaper className="h-5 w-5 mr-2 text-black shrink-0" />
              <div>Compares coverage across multiple sources</div>
            </div>
            <div className="flex items-start">
              <BarChart2 className="h-5 w-5 mr-2 text-black shrink-0" />
              <div>Identifies factual consistencies and discrepancies</div>
            </div>
            <div className="flex items-start">
              <Brain className="h-5 w-5 mr-2 text-black shrink-0" />
